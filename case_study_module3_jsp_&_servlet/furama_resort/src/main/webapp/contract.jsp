    ...
    <div class="col-md-3">
        <div class="list-group">
            <button type="button" class="list-group-item list-group-item-action active">
                <a href="/contract?action=create" style="color: white">Create Contract</a>
            </button>
            <button type="button" class="list-group-item list-group-item-action active">
                <a href="/contractDetail?action=create" style="color: white">Create Contract Detail</a>
            </button>
            <%--<button type="button" class="list-group-item list-group-item-action">
                <a href="/employee?action=listEmployee" style="color: darkblue">List Employee</a>
            </button>
            <button type="button" class="list-group-item list-group-item-action">
                <a href="/employee?action=searchEmployee" style="color: darkblue">Search Employee</a>
            </button>--%>
            <%--<button type="button" class="list-group-item list-group-item-action">
