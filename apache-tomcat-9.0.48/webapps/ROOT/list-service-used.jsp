    ...
    <div class="col-md-3">
        <div class="list-group">
            ...
            <button type="button" class="list-group-item list-group-item-action">
                <a href="/service?action=listServiceUsed" style="color: darkblue">List Service Used</a>
            </button>
    ...
    <div class="col-md-9">
        <div>
            <table border="1" cellpadding="5">
                ...
                <c:forEach var="customer" varStatus="loop" items="${listCustomerUsed}">
                    <tr>
                        <td><c:out value="${customer.customerId}"/></td>
                        <td><c:out value="${customer.customerName}"/></td>
                        <td><c:out value="${customer.customerTypeId}"/></td>
                        <td>
                            <c:out value="${listServiceUsed[loop.index].serviceId}"></c:out>
                        </td>
                        <td>
                            <c:out value="${listServiceUsed[loop.index].serviceName}"></c:out>
                        </td>
                        <td>
                            <c:out value="${listServiceUsed[loop.index].serviceCost}"></c:out>
                        </td>
                        <td>
                            <c:out value="${listAttachUsed[loop.index].attachServiceName}"></c:out>
                        </td>
                        <td>
                            <c:out value="${listAttachUsed[loop.index].attachServiceCost}"></c:out>
                        </td>
                        <td>
                            <c:out value="${listAttachUsed[loop.index].attachServiceUnit}"></c:out>
                        </td>
                    </tr>
                </c:forEach>
                ...
                <c:forEach var="service" items="${listServiceUsed}">
                    <tr>
