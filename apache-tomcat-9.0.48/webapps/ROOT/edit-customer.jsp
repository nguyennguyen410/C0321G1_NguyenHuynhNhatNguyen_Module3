            ...
            <form method="post">
                <table class="table" cellpadding="5">
                    ...
                    <tr>
                        <th>Customer Id:</th>
                        <td>
                            <input value="${customer.customerId}" type="text" name="customerId" id="customerId" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Type Id:</th>
                        <td>
                            <input value="${customer.customerTypeId}" type="text" name="customerTypeId" id="customerTypeId" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Name:</th>
                        <td>
                            <input value="${customer.customerName}" type="text" name="customerName" id="customerName" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Birthday:</th>
                        <td>
                            <input value="${customer.customerBirthday}" type="text" name="customerBirthday" id="customerBirthday" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Gender:</th>
                        <td>
                            <input value="${customer.customerGender}" type="text" name="customerGender" id="customerGender" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Id Card:</th>
                        <td>
                            <input value="${customer.customerIdCard}" type="text" name="customerIdCard" id="customerIdCard" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Phone:</th>
                        <td>
                            <input value="${customer.customerPhone}" type="text" name="customerPhone" id="customerPhone" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Email:</th>
                        <td>
                            <input value="${customer.customerEmail}" type="text" name="customerEmail" id="customerEmail" size="45"/>
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Adress:</th>
                        <td>
                            <input value="${customer.customerAddress}" type="text" name="customerAddress" id="customerAddress" size="45"/>
                        </td>
                    </tr>
                    <tr>
