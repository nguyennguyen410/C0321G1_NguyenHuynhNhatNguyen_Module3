    ...
    <div class="col-md-9">
        <div align="center">
            <table border="1" cellpadding="5">
                ...
                <c:forEach var="employee" items="${employeeSearch}">
                    <tr>
                        ...
                        <td>
                            <a href="/employee?action=editEmployee&employeeId=${employee.employeeId}">Edit</a>
                            <button onclick="onDelete('${employee.employeeId}','${employee.employeeName}')" type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal">Delete</button>
                        </td>
                    </tr>
                </c:forEach>
                <!-- Modal -->
